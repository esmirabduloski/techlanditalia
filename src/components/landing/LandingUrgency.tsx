    ...
    <section className="py-20 px-4 bg-gradient-to-br from-primary/5 via-secondary/5 to-tech-teal/5">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative rounded-3xl border-2 border-secondary/30 bg-card p-10 md:p-14 text-center overflow-hidden"
        >
          {/* Glow effect */}
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <span className="font-bold">I posti si stanno esaurendo!</span>
            </motion.div>
