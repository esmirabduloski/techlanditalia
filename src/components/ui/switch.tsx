  ...
  <div className="flex h-6 items-center">
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          "pointer-events-none block h-[15px] w-[15px] rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-[28px] data-[state=unchecked]:translate-x-0",
        )}
      />
    </SwitchPrimitives.Root>
  </div>
