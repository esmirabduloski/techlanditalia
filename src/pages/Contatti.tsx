...
const contactSchema = z.object({
  nome: z.string().trim().min(1, "Il nome è obbligatorio").max(100, "Il nome non può superare i 100 caratteri"),
  email: z.string().trim().email("Formato email non valido").max(254, "L'email non può superare i 254 caratteri"),
  oggetto: z.string().trim().min(1, "L'oggetto è obbligatorio").max(200, "L'oggetto non può superare i 200 caratteri"),
  messaggio: z
    .string()
    .trim()
