    ...
    modules: [
      {
        ...
        lessons: [
          "Lezione 1: Introduzione al mondo di Minecraft. Esplorazione di Minecraft Education e MakeCode",
          "Lezione 2: Esplorazione dei comandi di movimento e mini-missione con labirinto",
          "Lezione 3: Dalle azioni semplici agli algoritmi. Apprendimento del ciclo di ripetizione",
          "Lezione 4: Costruire in squadra. Pianificare e costruire un edificio semplice",
          "Lezione 5: Lavorare con redstone per creare porte automatizzate",
          "Lezione 6: Utilizzare redstone e osservatori per costruire una fattoria complessa",
          "Lezione 7: Studiare i meccanismi in squadra per lo sviluppo della città",
          "Lezione 8: Completare la costruzione della città con MakeCode",
        ],
      ...
      },
      {
        ...
        lessons: [
          "Lezione 1: Comprensione delle coordinate per la costruzione ad alta precisione",
          "Lezione 2: Progettazione di costruzioni su larga scala con loop annidati",
          "Lezione 3: Un progetto Agent – costruzione di un ponte sul fiume",
          "Lezione 4: Clonare oggetti per costruzioni simmetriche",
          "Lezione 5: Progettare una casa intelligente con automazione",
          "Lezione 6: Pianificare la disposizione delle strade e dei quartieri",
          "Lezione 7: Un progetto collaborativo – sviluppare il centro della città",
          "Lezione 8: Completamento del progetto finale – il 'Quartiere intelligente'",
        ],
      ...
      },
      {
        ...
        lessons: [
          "Lezione 1: Introduzione agli eventi e alle condizioni",
          "Lezione 2: Variabili e contatori per tenere traccia dei punteggi",
          "Lezione 3: È ora di intrappolare i mob! Programmare trappole",
          "Lezione 4: Progettazione del gioco 'Trova il pulsante'",
          "Lezione 5: Sviluppo del gioco 'Fuggi dalla lava'",
          "Lezione 6: Aggiunta di una zona di teletrasporto",
          "Lezione 7: Test e bilanciamento del gioco",
          "Lezione 8: Completare il progetto finale: 'Il mio gioco'",
        ],
      ...
      },
      {
        ...
        lessons: [
          "Lezione 1: Introduzione all'automazione – come funzionano le fattorie automatiche",
          "Lezione 2: Programmare un agente giardiniere",
          "Lezione 3: Costruire catene logiche condizionali",
          "Lezione 4: Progettare un selezionatore di risorse",
          "Lezione 5: Sviluppare una mob farm",
          "Lezione 6: Costruire un sistema di stoccaggio automatizzato",
          "Lezione 7: Manutenzione e ottimizzazione delle fattorie",
          "Lezione 8: Completamento del progetto finale: la 'fattoria intelligente'",
        ],
      ...
      },
      {
        ...
        lessons: [
          "Lezione 1: Generare idee e selezionare un progetto",
          "Lezione 2: Creare un piano di progetto e assegnare i ruoli",
          "Lezione 3: Scrivere le prime righe di codice per i meccanismi base",
          "Lezione 4: Perfezionare le creazioni aggiungendo logica e automazione",
          "Lezione 5: Lavorare con le funzioni riutilizzabili",
          "Lezione 6: Gestire gli eventi per rispondere alle azioni dei giocatori",
          "Lezione 7: Aggiungere gli ultimi ritocchi e decorazioni",
          "Lezione 8: Presentare e difendere il progetto davanti alla classe",
        ],
    ...
    modules: [
      {
        ...
        lessons: [
          "М1L1. Gli strumenti dei veri programmatori!",
          "М1L2. Gli strumenti dei veri programmatori! VsCode",
          "М1L3. Importiamo la nostra prima libreria!",
          "М1L4. Il bot risponde già alle nostre richieste!",
        ],
      ...
      },
      {
        ...
        lessons: [
          "М2L1. File e cartelle",
          "М2L2. Applicare la nostra conoscenza",
          "М2L3. Introduzione allo sviluppo web.",
          "М2L4. HTML e CSS",
        ],
      ...
      },
      {
        ...
        lessons: [
          "М3L1. Flask. Configurazione dell'ambiente.",
          "М3L2. Modelli e strumenti di template",
          "М3L3. Imparare i percorsi web e come non perdere le pagine web.",
          "М3L4. Una lezione segreta! Cambiare le pagine dinamicamente.",
        ],
      ...
      },
      {
        ...
        lessons: [
          "М4L1. Database. Il Diario del programmatore",
          "М4L2. Autorizzazione degli utenti.",
          "М4L3. Distribuzione del progetto. Preparazione del portfolio.",
          "М4L4. Creazione di un sito web Portfolio",
        ],
      ...
      },
      {
        ...
        lessons: [
          "М5L1. Comprendere l'IA e l'apprendimento automatico.",
          "М5L2. I dati sono la chiave del successo. Estrazione di dati da fonti aperte.",
          "М5L3. Le basi del Natural Language Processing. La libreria NLTK. I generatori di liste di Python.",
          "М5L4. Visione computerizzata? Che cos'è?",
        ],
      ...
      },
      {
        ...
        lessons: [
          "М6L1. Imparare una nuova libreria! Usare i modelli addestrati con il codice!",
          "М6L2. Battaglia di AI! Organizzare una competizione, discutere e testare.",
          "М6L3. Imparare nuove librerie e fissare obiettivi!",
          "М6L4. Mettiamo in pratica la nostra conoscenza!",
        ],
      ...
      },
      {
        ...
        lessons: [
          "М7L1. Configurazione dell'IDE per il progetto precedentemente creato.",
          "М7L2. Inferenza del modello addestrato nel bot Discord.",
          "М7L3. Creare un traduttore vocale!",
          "М7L4. Aggiungere un pulsante e implementare la logica!",
        ],
      ...
      },
      {
        ...
        lessons: [
          "М8L1. Spiegazione di ciò che vogliamo ottenere. Analisi.",
          "М8L2. Elaborazione di una soluzione.",
          "М8L3. Testare, eseguire il debug e risolvere.",
          "М8L4. Dimostrazione della soluzione.",
        ],
