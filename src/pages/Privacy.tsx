            ...
            <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
              <section>
                ...
                <p className="text-muted-foreground">
                  Il Titolare del trattamento dei dati personali è TECHLAND, con sede in Italia. Per qualsiasi
                  informazione relativa al trattamento dei tuoi dati personali, puoi contattarci all'indirizzo email:{" "}
                  <a href="mailto:privacy@techland.it" className="text-primary hover:underline">
                    privacy@techland.it
                  </a>
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    <strong>Dati relativi ai minori:</strong> età del bambino, interessi formativi
                  </li>
                  <li>
                    <strong>Dati di navigazione:</strong> indirizzo IP, tipo di browser, pagine visitate
                  </li>
                  <li>
                    <strong>Comunicazioni:</strong> messaggi inviati tramite i form di contatto o chat
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Il trattamento dei dati è basato sul tuo consenso, sull'esecuzione di un contratto o di misure
                  precontrattuali, e sull'adempimento di obblighi legali. Per quanto riguarda i dati dei minori, il
                  consenso viene fornito dal genitore o tutore legale.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  I dati personali vengono conservati per il tempo necessario a soddisfare le finalità per cui sono
                  stati raccolti. I dati relativi alle richieste di informazioni vengono conservati per un massimo di 24
                  mesi. I dati relativi agli iscritti ai corsi vengono conservati per la durata del rapporto
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    <strong>Opposizione:</strong> opporti al trattamento per marketing diretto
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Il nostro sito utilizza cookie tecnici necessari per il funzionamento del sito. Non utilizziamo cookie
                  di profilazione senza il tuo consenso esplicito. Puoi gestire le preferenze sui cookie attraverso le
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Adottiamo misure tecniche e organizzative appropriate per proteggere i tuoi dati personali da accessi
                  non autorizzati, perdita, distruzione o alterazione. Tuttavia, nessun sistema di trasmissione o
                  archiviazione dati è completamente sicuro.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  saranno pubblicate su questa pagina con la data di ultimo aggiornamento. Ti invitiamo a consultare
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Per qualsiasi domanda relativa a questa Privacy Policy o al trattamento dei tuoi dati personali, puoi
                  contattarci:
                </p>
              ...
              <section className="pt-8 border-t">
                <p className="text-sm text-muted-foreground">
                  Hai anche il diritto di presentare un reclamo all'Autorità Garante per la Protezione dei Dati
                  Personali (
                  <a
