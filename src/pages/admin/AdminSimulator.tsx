...
import { 
  Loader2, Eye, User, Users, GraduationCap, LogOut, FileText, BookOpen, Mail, 
  BarChart3, Award, Search, Home 
} from "lucide-react";
      ...
      <div className="border-b bg-background">
        <div className="max-w-7xl mx-auto px-4">
          <nav className="flex gap-4 overflow-x-auto">
            ...
            <Link to="/admin/simulatore" className="py-3 px-2 border-b-2 border-primary text-primary font-medium flex items-center gap-2 whitespace-nowrap">
